...
- Изучаю **QA\QC, Java**
- Имею опыт в ручном и нагрузочном тестировании
- Прохожу курс автоматизированного тестирования на [QA.GURU](https://qa.guru/java)
- Прохожу курс по ЯП Java на [Job4j](https://job4j.ru/)
